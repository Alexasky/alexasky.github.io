					 ...
					 <div class="catalog-wrapper report-catalog-wrapper ">
							 ...
							 <div class="col-lg-4 item-catalog item-catalog-menu">
				 			 	<div class="item-catalog-block report-item-block">
									 <a class="menu-link" href="<?php echo get_permalink(); ?>"><div class="report-item"><?php the_post_thumbnail(array(327,181)); ?></div></a>
									 <div class="description">
									 	<a class="menu-link" href="<?php echo get_permalink(); ?>"><p class="title-item"><?php the_title(); ?></p></a>
									 </div>
				 			 </div>
							</div>
			 <?php endwhile; ?>
